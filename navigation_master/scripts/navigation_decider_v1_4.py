...
class NavigationDeciderV1_4():
    ...
    def adhoc_path_publisher(self):
        while not rospy.is_shutdown():
            ...
            print "action[0] :  " + str(self.action)
...
#                        self.init_lift_pub.publish("2")
    ...
    def obstacle_detector(self):
        if(int(self.lifter) == 1):    # With Table On Top
...
if __name__=="__main__":
    rospy.init_node("navigation_decider_v1_4")
    NavigationDeciderV1_4()
    rospy.spin()
