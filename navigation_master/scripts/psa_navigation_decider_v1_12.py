...
"""
Changes :  (1) Data Logger activate when receiving new mission
           (2) Data Logger turn OFF after finishing a mission
           (3) Data Logging is saved and named according to mission id
"""
...
class PsaNavigationDeciderV1_12():
    def __init__(self):
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1_12")
    PsaNavigationDeciderV1_12()
    rospy.spin()
