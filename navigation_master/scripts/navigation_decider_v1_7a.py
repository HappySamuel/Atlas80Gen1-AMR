...
class NavigationDeciderV1_7a():
    def __init__(self):
        ...
        self.pub_rate = rospy.Rate(4)    # 0.5 [Hz] <---> 2 [sec]
...
if __name__=="__main__":
    rospy.init_node("navigation_decider_v1_7a")
    NavigationDeciderV1_7a()
    rospy.spin()
