...
class PsaNavigationDeciderV1_18():
    def __init__(self):
        ...
        if(len(self.action) >=1):
            ...
            # Drop Table ----- (1) Turning 180', (2) Drop Table
                ...
                if(self.finish_180_turn == False or self.finish_lift == False):
                    ...
                    elif(self.step_counter == 2 and self.finish_180_turn == True and self.finish_lift == False):
                        self.init_180_turn_pub.publish(False)
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1_18")
    PsaNavigationDeciderV1_18()
    rospy.spin()
