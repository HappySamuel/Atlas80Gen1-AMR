...
"""
Changes :  (1) Obstacle Stop mode always recycling
"""
...
class PsaNavigationDeciderV1_5():
    def __init__(self):
        ...
        self.path_31 = self.path_directory + "/psa_charging.traj"
        self.path_32 = self.path_directory + "/psa_completed.traj"
    ...
    def mission_done_checker(self):
        if(self.route != []):
            ...
            if(self.dist_checker(self.c_pose, self.end_pt) and self.counter == 1 and self.last_end_pt[0] != self.end_pt[0] and self.last_end_pt[1] != self.end_pt[1]):
                self.counter = 2
                del self.route[0]
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1-5")
    PsaNavigationDeciderV1_5()
    rospy.spin()
