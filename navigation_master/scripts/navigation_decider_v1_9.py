...
Changes :  (1) Heading Turner (-/+90') upon arrival at location
"""
...
class NavigationDeciderV1_9():
    ...
    def lifterCB(self, msg):
        ...
        if(lifter_status == 1):
            ...
            if(self.start_check == True):
                ...
                self.finish_lift = False       # On Going
        self.ls = str(lifter_status) + ",sc="+str(self.start_check) + ",fl="+str(self.finish_lift)
    ...
    def adhoc_path_publisher(self):
        while not rospy.is_shutdown():
            ...
            self.finish_180_turn = False    # Reset the finish_180_turn after done each action
    ...
    def mission_start_checker(self):
        if(self.delivery_status == "started" and self.dist_checker(self.c_pose, self.check_point, self.waypt_tolerance)):
    ...
    def heading_turner_checker(self):
        if(self.heading != "" and self.dist_checker(self.c_pose, self.prev_end_pt, 0.4) == True):
            if(self.heading_counter == 1):
    ...
    def obstacle_detector(self):
        ...
        elif(int(self.lifter) == 0 and self.obstacle_mode == 1 and self.dist_checker(self.c_pose, self.start_pt, self.waypt_tolerance) == False):  # Without Table On Top
...
if __name__=="__main__":
    rospy.init_node("navigation_decider_v1_9")
    NavigationDeciderV1_9()
    rospy.spin()
