...
"""
Changes :  (1) Provide routes from service bay 1-5 and warehouse A-C
"""
...
class PsaNavigationDeciderV1_8():
    def __init__(self):
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1_8")
    PsaNavigationDeciderV1_8()
    rospy.spin()
