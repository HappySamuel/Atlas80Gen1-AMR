...
class PsaNavigationDeciderV1_15():
    def __init__(self):
    ...
    def heading_turner_checker(self):
        if(self.heading != "" and self.dist_checker(self.c_pose, self.prev_end_pt, 0.2) == True and self.heading_counter == 1):
...
#        print "self.dist_checker(self.c_pose, self.start_pt, 2.0) :  " + str(self.dist_checker(self.c_pose, self.start_pt, 2.0))
#        print "self.c_pose :  " + str(self.c_pose)
#        print "self.start_pt :  " + str(self.start_pt)
#        print "self.obstacle_mode :  " + str(self.obstacle_mode)
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1_15")
    PsaNavigationDeciderV1_15()
    rospy.spin()
