...
"""
Changes :  (1) Compatible with magnetic_follower_v1_3.py
...
class PsaNavigationDeciderV1_13():
    def __init__(self):
...
if __name__=="__main__":
    rospy.init_node("psa_navigation_decider_v1_13")
    PsaNavigationDeciderV1_13()
    rospy.spin()
